            ...
            <div class="col-8 offset-2 mt-5 d-flex flex-wrap justify-content-center ">
                ...
                @foreach ($restaurants as $restaurant)
                    ...
                    <div class="card mr-3 mb-3" style="width: 35rem;">
                        <div class="card-body">
                            <img width="50%" alt="{{ $restaurant->name }}"
                            ...
                            <a class="btn btn-primary" href="{{ route('restaurant.show', $restaurant->id) }}">Mostra
                                Ordini</a>
                            @if (Auth::check())
                                @if (Auth::User()->id == $restaurant->getRestaurateur->id)
                                    ...
                                    <a class=" mt-1 btn btn-warning"href="{{ route("restaurant.edit",$restaurant->id) }}">MODIFICA RISTORANTE</a>
